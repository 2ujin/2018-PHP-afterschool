<?
    ...
    $userlevel = $_SESSION[userlevel]; //SESSION 정보 유지 
?>
...
<?
//코드 추가 DB 내용이 폼에 나올 수 있도록 id로 검색해서 DB로 연동 update set where id
...
?>
	...
	<div id="col2">
		...
		<div id="form_join">
			...
			value="<?= $row[pass]?>"></li>
			<li><input type="password" name="pass_confirm" 
			value="<?= $row[pass] ?>"></li>	
			<li><input type="text" name="name" 
			value="<?= $row[name]?>"></li>
			<li><div id="nick1"><input type="text" name="nick" 
			value="<?= $row[nick] ?>"></div>
				<div id="nick2" ><a href="#"><img src="../img/check_id.gif" onclick="check_nick()"></a></div></li>
			<li><input type="text" class="hp" name="hp1" 
			value="<?= $hp1 ?>"> 
